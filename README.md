...
## Cara Kompilasi
Proyek ini membutuhkan lingkungan pengembangan Java standar. Berikut adalah langkah-langkah kompilasinya:
- Pastikan Anda telah menginstal Java (JDK 11 atau yang lebih baru) pada sistem operasi Anda.
- Clone repositori proyek ini ke direktori lokal mesin Anda.  Buka direktori proyek menggunakan IDE Java pilihan Anda, seperti IntelliJ IDEA, Eclipse, atau NetBeans.
- Pastikan struktur package proyek telah dikonfigurasi dan terbaca dengan benar (meliputi package model, view, controller, util, dan app).
- Jalankan fitur Build atau Compile bawaan dari IDE Anda untuk memastikan seluruh kode terkompilasi tanpa adanya error.
## Cara Menjalankan
- Buka struktur package aplikasi pada IDE, lalu arahkan ke package app.  
- Temukan entry point aplikasi pada kelas Main.java.  
- Eksekusi (Run) file Main.java tersebut.
